  ...
  if (costData === "" || enjoyDish === "") {
    ...
    try {
      ...
      const response = await axios.post(
        "https://crudcrud.com/api/eba8ab4b4bf948e194bab087333d3840/data",
        billData
      );
...
async function deleteFormData(id, tableElement, billList) {
  try {
    ...
    const response = await axios.delete(
      `https://crudcrud.com/api/eba8ab4b4bf948e194bab087333d3840/data/${id}`
    );
    console.log(response);
...
async function createEditButton(billData, tableElement, billList) {
  ...
  const updatedEnjoy = window.prompt(
    "Enter the updated dish name:",
    billData.enjoy
  );
  ...
  try {
    ...
    const response = await axios.put(
      `https://crudcrud.com/api/eba8ab4b4bf948e194bab087333d3840/data/${billData._id}`,
      {
        price: updatedCost,
        enjoy: updatedEnjoy,
